...
#pragma region WEAPON_20MM
	WEAPON_20MM_INITIAL_DMG = Lua_GetVariable("WEAPON_20MM_INITIAL_DMG", 3);
	WEAPON_20MM_ADDON_DMG = Lua_GetVariable("WEAPON_20MM_ADDON_DMG", 3);
	...
	WEAPON_20MM_ADDON_HEATDAMAGE = Lua_GetVariable("WEAPON_20MM_ADDON_HEATDAMAGE", 3);
#pragma endregion	
#pragma region SHOTGUN
	SHOTGUN_INITIAL_DAMAGE = Lua_GetVariable("SHOTGUN_INITIAL_DAMAGE", 3);
	SHOTGUN_ADDON_DAMAGE = Lua_GetVariable("SHOTGUN_ADDON_DAMAGE", 2);
	SHOTGUN_INITIAL_BULLETS = Lua_GetVariable("SHOTGUN_INITIAL_BULLETS", 10);
	SHOTGUN_ADDON_BULLETS = Lua_GetVariable("SHOTGUN_ADDON_BULLETS", 2);
#pragma endregion	
...
#pragma region MACHINEGUN
	...
	MACHINEGUN_ADDON_TRACERDAMAGE = Lua_GetVariable("MACHINEGUN_ADDON_TRACERDAMAGE", 14);
#pragma endregion	
...
#pragma region RAILGUN
	RAILGUN_INITIAL_DAMAGE = Lua_GetVariable("RAILGUN_INITIAL_DAMAGE", 90);
	RAILGUN_ADDON_DAMAGE = Lua_GetVariable("RAILGUN_ADDON_DAMAGE", 3);
...
#pragma endregion /*Weapons Parameters*/
	...
	MAX_MONSTERS = Lua_GetVariable("MAX_MONSTERS", 50);
	...
	// DRONE HEALTH N SHIELD CONFIGURATION
	 ...
	 DRONE_BRAIN_INITIAL_LIFE = Lua_GetVariable("DRONE_BRAIN_INITIAL_LIFE", 330);
	 DRONE_BRAIN_INITIAL_SHIELD = Lua_GetVariable("DRONE_BRAIN_INITIAL_SHIELD", 600);
	 ...
	 DRONE_SUPERTANK_INITIAL_LIFE = Lua_GetVariable("DRONE_SUPERTANK_INITIAL_LIFE", 15000);
	 ...
	 DRONE_COMMANDER_INITIAL_SHIELD = Lua_GetVariable("DRONE_COMMANDER_INITIAL_SHIELD", 7000);
	 ...
	 DRONE_LESSER_LIFE_FACTOR = Lua_GetVariable("DRONE_LESSER_LIFE_FACTOR", 1.3);
	 DRONE_LESSER_SHIELD_FACTOR = Lua_GetVariable("DRONE_LESSER_SHIELD_FACTOR", 1.5);

	 DRONE_MEDIUM_LIFE_FACTOR		= Lua_GetVariable("DRONE_MEDIUM_LIFE_FACTOR", 1.8);
	 DRONE_MEDIUM_SHIELD_FACTOR	= Lua_GetVariable("DRONE_MEDIUM_SHIELD_FACTOR", 1.8);

	 DRONE_BOSS_LIFE_FACTOR		= Lua_GetVariable("DRONE_BOSS_LIFE_FACTOR", 2.5);
	 DRONE_BOSS_SHIELD_FACTOR		= Lua_GetVariable("DRONE_BOSS_SHIELD_FACTOR", 2.5);
}