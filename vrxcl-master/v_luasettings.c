...
#pragma endregion /*Weapons Parameters*/
	...
	// DRONE HEALTH N SHIELD CONFIGURATION
	 ...
	 DRONE_MUTANT_INITIAL_LIFE  = Lua_GetVariable("DRONE_MUTANT_INITIAL_LIFE", 250);
	 DRONE_MUTANT_INITIAL_SHIELD = Lua_GetVariable("DRONE_MUTANT_INITIAL_SHIELD", 100);

	 DRONE_MEDIC_INITIAL_LIFE = Lua_GetVariable("DRONE_MEDIC_INITIAL_LIFE", 280);
	 DRONE_MEDIC_INITIAL_SHIELD = Lua_GetVariable("DRONE_MEDIC_INITIAL_SHIELD", 220);

	 DRONE_TANK_INITIAL_LIFE = Lua_GetVariable("DRONE_TANK_INITIAL_LIFE", 380);
	 DRONE_TANK_INITIAL_SHIELD = Lua_GetVariable("DRONE_TANK_INITIAL_SHIELD", 550);

	 DRONE_GLADIATOR_INITIAL_LIFE = Lua_GetVariable("DRONE_GUNNER_INITIAL_LIFE", 280);
	 DRONE_GLADIATOR_INITIAL_SHIELD = Lua_GetVariable("DRONE_GUNNER_INITIAL_SHIELD", 250);
	
	 DRONE_BRAIN_INITIAL_LIFE = Lua_GetVariable("DRONE_BRAIN_INITIAL_LIFE", 280);
	 DRONE_BRAIN_INITIAL_SHIELD = Lua_GetVariable("DRONE_BRAIN_INITIAL_SHIELD", 450);

	 DRONE_GUNNER_INITIAL_LIFE = Lua_GetVariable("DRONE_GUNNER_INITIAL_LIFE", 280);
	 DRONE_GUNNER_INITIAL_SHIELD = Lua_GetVariable("DRONE_GUNNER_INITIAL_SHIELD", 400);

	 DRONE_BERSERK_INITIAL_LIFE = Lua_GetVariable("DRONE_BERSERK_INITIAL_LIFE", 150);
	 DRONE_BERSERK_INITIAL_SHIELD = Lua_GetVariable("DRONE_BERSERK_INITIAL_SHIELD", 350);

	 DRONE_PARASITE_INITIAL_LIFE = Lua_GetVariable("DRONE_PARASITE_INITIAL_LIFE", 350);
	 DRONE_PARASITE_INITIAL_SHIELD = Lua_GetVariable("DRONE_PARASITE_INITIAL_SHIELD", 50);

	 DRONE_BITCH_INITIAL_LIFE = Lua_GetVariable("DRONE_BITCH_INITIAL_LIFE", 280);
	 ...
	 DRONE_INFANTRY_INITIAL_LIFE = Lua_GetVariable("DRONE_INFANTRY_INITIAL_LIFE", 250);
	 DRONE_INFANTRY_INITIAL_SHIELD = Lua_GetVariable("DRONE_INFANTRY_INITIAL_SHIELD", 350);



	 DRONE_LESSER_LIFE_FACTOR = Lua_GetVariable("DRONE_LESSER_LIFE_FACTOR", 15);
	 DRONE_LESSER_SHIELD_FACTOR = Lua_GetVariable("DRONE_LESSER_SHIELD_FACTOR", 18);

	 DRONE_MEDIUM_LIFE_FACTOR		= Lua_GetVariable("DRONE_MEDIUM_LIFE_FACTOR", 22);
	 DRONE_MEDIUM_SHIELD_FACTOR	= Lua_GetVariable("DRONE_MEDIUM_SHIELD_FACTOR", 33);

	 DRONE_BOSS_LIFE_FACTOR		= Lua_GetVariable("DRONE_BOSS_LIFE_FACTOR", 1);
	 DRONE_BOSS_SHIELD_FACTOR		= Lua_GetVariable("DRONE_BOSS_SHIELD_FACTOR", 2);
}