...
#pragma region SABRE
	...
	SABRE_INITIAL_RANGE = Lua_GetVariable("SABRE_INITIAL_RANGE", 200);
	SABRE_ADDON_RANGE = Lua_GetVariable("SABRE_ADDON_RANGE",15);
...
#pragma endregion /*Weapons Parameters*/
	...
	M_TANK_CONTROL_COST = Lua_GetVariable("M_TANK_CONTROL_COST", 15);
