...
double WEAPON_20MM_ADDON_HEATDAMAGE;
...
// MONSTER INITIAL STATUS
double DRONE_MUTANT_INITIAL_LIFE;
double DRONE_MUTANT_INITIAL_SHIELD;

double DRONE_TANK_INITIAL_LIFE;
double DRONE_TANK_INITIAL_SHIELD;

double DRONE_MEDIC_INITIAL_LIFE;
double DRONE_MEDIC_INITIAL_SHIELD;

double DRONE_PARASITE_INITIAL_LIFE;
double DRONE_PARASITE_INITIAL_SHIELD;

double DRONE_GUNNER_INITIAL_LIFE;
double DRONE_GUNNER_INITIAL_SHIELD;

double DRONE_GLADIATOR_INITIAL_LIFE;
double DRONE_GLADIATOR_INITIAL_SHIELD;

double DRONE_SUPERTANK_INITIAL_LIFE;
double DRONE_SUPERTANK_INITIAL_SHIELD;

double DRONE_COMMANDER_INITIAL_LIFE;
double DRONE_COMMANDER_INITIAL_SHIELD;

double DRONE_MAKRON_INITIAL_LIFE;
double DRONE_MAKRON_INITIAL_SHIELD;

double DRONE_JORG_INITIAL_LIFE;
double DRONE_JORG_INITIAL_SHIELD;

double DRONE_INFANTRY_INITIAL_LIFE;
double DRONE_INFANTRY_INITIAL_SHIELD;

double DRONE_BRAIN_INITIAL_LIFE;
double DRONE_BRAIN_INITIAL_SHIELD;

double DRONE_BITCH_INITIAL_LIFE;
double DRONE_BITCH_INITIAL_SHIELD;

double DRONE_BERSERK_INITIAL_LIFE;
double DRONE_BERSERK_INITIAL_SHIELD;

double DRONE_LESSER_LIFE_FACTOR;
double DRONE_LESSER_SHIELD_FACTOR;

double DRONE_MEDIUM_LIFE_FACTOR;
double DRONE_MEDIUM_SHIELD_FACTOR;

double DRONE_BOSS_LIFE_FACTOR;
double DRONE_BOSS_SHIELD_FACTOR;
...
void Lua_LoadVariables()
{
	...
	EXP_WORLD_MONSTER = Lua_GetVariable("EXP_WORLD_MONSTER", 1);
	...
	//SOLDIER
	INITIAL_HEALTH_SOLDIER = Lua_GetVariable("INITIAL_HEALTH_SOLDIER", 82);
	LEVELUP_HEALTH_SOLDIER = Lua_GetVariable("LEVELUP_HEALTH_SOLDIER", 5);
	INITIAL_ARMOR_SOLDIER = Lua_GetVariable("INITIAL_ARMOR_SOLDIER", 45);
	...
	ADDON_POWERCUBES_SOLDIER = Lua_GetVariable("ADDON_POWERCUBES_SOLDIER", 15);


	INITIAL_HEALTH_ENGINEER = Lua_GetVariable("INITIAL_HEALTH_ENGINEER", 75);
	LEVELUP_HEALTH_ENGINEER = Lua_GetVariable("LEVELUP_HEALTH_ENGINEER", 4);
	INITIAL_ARMOR_ENGINEER = Lua_GetVariable("INITIAL_ARMOR_ENGINEER", 80);
	...
	ADDON_POWERCUBES_ENGINEER = Lua_GetVariable("ADDON_POWERCUBES_ENGINEER", 20);


	INITIAL_HEALTH_VAMPIRE = Lua_GetVariable("INITIAL_HEALTH_VAMPIRE", 115);
	LEVELUP_HEALTH_VAMPIRE = Lua_GetVariable("LEVELUP_HEALTH_VAMPIRE", 9);
	INITIAL_ARMOR_VAMPIRE = Lua_GetVariable("INITIAL_ARMOR_VAMPIRE", 35);
	...
	ADDON_POWERCUBES_VAMPIRE = Lua_GetVariable("ADDON_POWERCUBES_VAMPIRE", 15);


	INITIAL_HEALTH_POLTERGEIST = Lua_GetVariable("INITIAL_HEALTH_POLTERGEIST", 112); //ALIEN
	LEVELUP_HEALTH_POLTERGEIST = Lua_GetVariable("LEVELUP_HEALTH_POLTERGEIST", 11);
	INITIAL_ARMOR_POLTERGEIST = Lua_GetVariable("INITIAL_ARMOR_POLTERGEIST", 10);
	LEVELUP_ARMOR_POLTERGEIST = Lua_GetVariable("LEVELUP_ARMOR_POLTERGEIST", 2);
	INITIAL_POWERCUBES_POLTERGEIST = Lua_GetVariable("INITIAL_POWERCUBES_POLTERGEIST", 200);
	ADDON_POWERCUBES_POLTERGEIST = Lua_GetVariable("ADDON_POWERCUBES_POLTERGEIST", 20);
	...
	INITIAL_HEALTH_MAGE = Lua_GetVariable("INITIAL_HEALTH_MAGE", 90);
	...
	// ARMADURA INICIAL
	INITIAL_ARMOR_KNIGHT = Lua_GetVariable("INITIAL_ARMOR_KNIGHT", 85);
	...
	// ARMADURA POR NIVEL
	LEVELUP_ARMOR_KNIGHT = Lua_GetVariable("LEVELUP_ARMOR_KNIGHT", 12);
	...
	SHELLS_PICKUP = Lua_GetVariable("SHELLS_PICKUP", 40);
	BULLETS_PICKUP = Lua_GetVariable("BULLETS_PICKUP", 70);
	GRENADES_PICKUP = Lua_GetVariable("GRENADES_PICKUP", 25);
	ROCKETS_PICKUP = Lua_GetVariable("ROCKETS_PICKUP", 25);
	CELLS_PICKUP = Lua_GetVariable("CELLS_PICKUP", 70);
	SLUGS_PICKUP = Lua_GetVariable("SLUGS_PICKUP", 30);
	...
	EXP_PLAYER_BASE = Lua_GetVariable("EXP_PLAYER_BASE", 35);
...
#pragma region SABRE
	...
	SABRE_ADDON_DAMAGE = Lua_GetVariable("SABRE_ADDON_DAMAGE", 11);
	SABRE_ADDON_HEATDAMAGE = Lua_GetVariable("SABRE_ADDON_HEATDAMAGE", 3);
	SABRE_INITIAL_RANGE = Lua_GetVariable("SABRE_INITIAL_RANGE", 125);
	SABRE_ADDON_RANGE = Lua_GetVariable("SABRE_ADDON_RANGE",5);
	SABRE_INITIAL_KICK = Lua_GetVariable("SABRE_INITIAL_KICK", 60);
...
#pragma region BLASTER
	...
	BLASTER_INITIAL_DAMAGE_MAX = Lua_GetVariable("BLASTER_INITIAL_DAMAGE_MAX", 25);
	BLASTER_ADDON_DAMAGE_MIN = Lua_GetVariable("BLASTER_ADDON_DAMAGE_MIN", 7);
	BLASTER_ADDON_DAMAGE_MAX = Lua_GetVariable("BLASTER_ADDON_DAMAGE_MAX", 14);
...
#pragma region WEAPON_20MM
	WEAPON_20MM_INITIAL_DMG = Lua_GetVariable("WEAPON_20MM_INITIAL_DMG", 7);
	WEAPON_20MM_ADDON_DMG = Lua_GetVariable("WEAPON_20MM_ADDON_DMG", 4);
	WEAPON_20MM_INITIAL_RANGE = Lua_GetVariable("WEAPON_20MM_INITIAL_RANGE", 1450);
	WEAPON_20MM_ADDON_RANGE = Lua_GetVariable("WEAPON_20MM_ADDON_RANGE", 45);
	WEAPON_20MM_ADDON_HEATDAMAGE = Lua_GetVariable("WEAPON_20MM_ADDON_HEATDAMAGE", 2.5);
#pragma endregion	
...
#pragma region SUPERSHOTGUN
	SUPERSHOTGUN_INITIAL_DAMAGE = Lua_GetVariable("SUPERSHOTGUN_INITIAL_DAMAGE", 6);
	SUPERSHOTGUN_ADDON_DAMAGE = Lua_GetVariable("SUPERSHOTGUN_ADDON_DAMAGE", 1);
	SUPERSHOTGUN_INITIAL_BULLETS = Lua_GetVariable("SUPERSHOTGUN_INITIAL_BULLETS", 12);
	SUPERSHOTGUN_ADDON_BULLETS = Lua_GetVariable("SUPERSHOTGUN_ADDON_BULLETS", 1);
#pragma endregion	
#pragma region MACHINEGUN
	MACHINEGUN_INITIAL_DAMAGE = Lua_GetVariable("MACHINEGUN_INITIAL_DAMAGE", 5);
	MACHINEGUN_ADDON_DAMAGE = Lua_GetVariable("MACHINEGUN_ADDON_DAMAGE", 2);
	MACHINEGUN_ADDON_TRACERDAMAGE = Lua_GetVariable("MACHINEGUN_ADDON_TRACERDAMAGE", 8);
#pragma endregion	
#pragma region CHAINGUN

	CHAINGUN_INITIAL_DAMAGE = Lua_GetVariable("CHAINGUN_INITIAL_DAMAGE", 4);
...
#pragma region GRENADES
	GRENADE_INITIAL_DAMAGE = Lua_GetVariable("GRENADE_INITIAL_DAMAGE", 130);
	GRENADE_ADDON_DAMAGE = Lua_GetVariable("GRENADE_ADDON_DAMAGE", 12);
	GRENADE_INITIAL_RADIUS_DAMAGE = Lua_GetVariable("GRENADE_INITIAL_RADIUS_DAMAGE", 60);
	GRENADE_ADDON_RADIUS_DAMAGE = Lua_GetVariable("GRENADE_ADDON_RADIUS_DAMAGE", 15);
	GRENADE_INITIAL_RADIUS = Lua_GetVariable("GRENADE_INITIAL_RADIUS", 60);
	GRENADE_ADDON_RADIUS = Lua_GetVariable("GRENADE_ADDON_RADIUS", 5);
#pragma endregion	
#pragma region GRENADELAUNCHER
	GRENADELAUNCHER_INITIAL_DAMAGE = Lua_GetVariable("GRENADELAUNCHER_INITIAL_DAMAGE", 120);
	GRENADELAUNCHER_ADDON_DAMAGE = Lua_GetVariable("GRENADELAUNCHER_ADDON_DAMAGE", 10);
	GRENADELAUNCHER_INITIAL_RADIUS_DAMAGE = Lua_GetVariable("GRENADELAUNCHER_INITIAL_RADIUS_DAMAGE", 100);
	GRENADELAUNCHER_ADDON_RADIUS_DAMAGE = Lua_GetVariable("GRENADELAUNCHER_ADDON_RADIUS_DAMAGE", 15);
	...
	GRENADELAUNCHER_INITIAL_SPEED = Lua_GetVariable("GRENADELAUNCHER_INITIAL_SPEED", 700);
...
#pragma region ROCKETLAUNCHER
	...
	ROCKETLAUNCHER_ADDON_DAMAGE = Lua_GetVariable("ROCKETLAUNCHER_ADDON_DAMAGE", 10);
	...
	ROCKETLAUNCHER_ADDON_RADIUS_DAMAGE = Lua_GetVariable("ROCKETLAUNCHER_ADDON_RADIUS_DAMAGE", 15);
	ROCKETLAUNCHER_INITIAL_DAMAGE_RADIUS = Lua_GetVariable("ROCKETLAUNCHER_INITIAL_DAMAGE_RADIUS", 108);
	ROCKETLAUNCHER_ADDON_DAMAGE_RADIUS = Lua_GetVariable("ROCKETLAUNCHER_ADDON_DAMAGE_RADIUS", 12);
#pragma endregion	
#pragma region HYPERBLASTER
	HYPERBLASTER_INITIAL_DAMAGE = Lua_GetVariable("HYPERBLASTER_INITIAL_DAMAGE", 15);
	HYPERBLASTER_ADDON_DAMAGE = Lua_GetVariable("HYPERBLASTER_ADDON_DAMAGE", 5);
	HYPERBLASTER_INITIAL_SPEED = Lua_GetVariable("HYPERBLASTER_INITIAL_SPEED", 800);
	HYPERBLASTER_ADDON_SPEED = Lua_GetVariable("HYPERBLASTER_ADDON_SPEED", 25);
#pragma endregion	
#pragma region RAILGUN
	RAILGUN_INITIAL_DAMAGE = Lua_GetVariable("RAILGUN_INITIAL_DAMAGE", 100);
	RAILGUN_ADDON_DAMAGE = Lua_GetVariable("RAILGUN_ADDON_DAMAGE", 11);
	RAILGUN_ADDON_HEATDAMAGE = Lua_GetVariable("RAILGUN_ADDON_HEATDAMAGE", 2);

#pragma endregion
#pragma region BFG10K
	BFG10K_INITIAL_DAMAGE = Lua_GetVariable("BFG10K_INITIAL_DAMAGE", 50);
	BFG10K_ADDON_DAMAGE = Lua_GetVariable("BFG10K_ADDON_DAMAGE", 2);
	BFG10K_INITIAL_SPEED = Lua_GetVariable("BFG10K_INITIAL_SPEED", 750);
	BFG10K_ADDON_SPEED = Lua_GetVariable("BFG10K_ADDON_SPEED", 45);
	BFG10K_RADIUS = Lua_GetVariable("BFG10K_RADIUS", 280);
	BFG10K_INITIAL_DURATION = Lua_GetVariable("BFG10K_INITIAL_DURATION", 0.2);
	BFG10K_ADDON_DURATION = Lua_GetVariable("BFG10K_ADDON_DURATION", 0.065);
	BFG10K_DEFAULT_DURATION = Lua_GetVariable("BFG10K_DEFAULT_DURATION", 0.1);
...
#pragma endregion /*Weapons Parameters*/
	...
	FURY_ADDON_REGEN = Lua_GetVariable("FURY_ADDON_REGEN", 0.07);
	FURY_MAX_REGEN = Lua_GetVariable("FURY_MAX_REGEN", 0.5);
	FURY_INITIAL_FACTOR = Lua_GetVariable("FURY_INITIAL_FACTOR", 1.1);
	FURY_ADDON_FACTOR = Lua_GetVariable("FURY_ADDON_FACTOR", 0.1);
	FURY_FACTOR_MAX = Lua_GetVariable("FURY_FACTOR_MAX", 1.5);
	FURY_DURATION_BASE = Lua_GetVariable("FURY_DURATION_BASE", 2);
	FURY_DURATION_BONUS = Lua_GetVariable("FURY_DURATION_BONUS", 1.5);
	...
	PRECISION_TUNING_COST_FACTOR = Lua_GetVariable("PRECISION_TUNING_COST_FACTOR", 0.2);
	PRECISION_TUNING_DELAY_FACTOR = Lua_GetVariable("PRECISION_TUNING_DELAY_FACTOR", 0.3);
	PRECISION_TUNING_SKILL_FACTOR = Lua_GetVariable("PRECISION_TUNING_SKILL_FACTOR", 0.2);
	
	SENTRY_INITIAL_HEALTH = Lua_GetVariable("SENTRY_INITIAL_HEALTH", 350);
	SENTRY_ADDON_HEALTH = Lua_GetVariable("SENTRY_ADDON_HEALTH", 80);
	SENTRY_INITIAL_ARMOR = Lua_GetVariable("SENTRY_INITIAL_ARMOR", 380);
	SENTRY_ADDON_ARMOR = Lua_GetVariable("SENTRY_ADDON_ARMOR", 75);
	SENTRY_INITIAL_AMMO = Lua_GetVariable("SENTRY_INITIAL_AMMO", 150);
	SENTRY_ADDON_AMMO = Lua_GetVariable("SENTRY_ADDON_AMMO", 30);
	
	MINISENTRY_INITIAL_HEALTH = Lua_GetVariable("MINISENTRY_INITIAL_HEALTH", 280);
	MINISENTRY_ADDON_HEALTH = Lua_GetVariable("MINISENTRY_ADDON_HEALTH", 65);
	MINISENTRY_INITIAL_ARMOR = Lua_GetVariable("MINISENTRY_INITIAL_ARMOR", 350);
	...
	MINISENTRY_MAX_BULLET = Lua_GetVariable("MINISENTRY_MAX_BULLET", 500);
	...
	SENTRY_INITIAL_BULLETDAMAGE = Lua_GetVariable("SENTRY_INITIAL_BULLETDAMAGE", 8);
	SENTRY_ADDON_BULLETDAMAGE = Lua_GetVariable("SENTRY_ADDON_BULLETDAMAGE", 5);
	SENTRY_INITIAL_ROCKETDAMAGE = Lua_GetVariable("SENTRY_INITIAL_ROCKETDAMAGE", 120);
	SENTRY_ADDON_ROCKETDAMAGE = Lua_GetVariable("SENTRY_ADDON_ROCKETDAMAGE", 25);
	SENTRY_INITIAL_ROCKETSPEED = Lua_GetVariable("SENTRY_INITIAL_ROCKETSPEED", 1050);
	SENTRY_ADDON_ROCKETSPEED = Lua_GetVariable("SENTRY_ADDON_ROCKETSPEED", 95);
	SENTRY_COST = Lua_GetVariable("SENTRY_COST", 25);
	SENTRY_MAX = Lua_GetVariable("SENTRY_MAX", 1);
	SENTRY_UPGRADE = Lua_GetVariable("SENTRY_UPGRADE", 35);
	
	DELAY_SENTRY_SCAN = Lua_GetVariable("DELAY_SENTRY_SCAN", 2);
	DELAY_SENTRY = Lua_GetVariable("DELAY_SENTRY", 1);
	
	SPIKER_MAX_COUNT = Lua_GetVariable("SPIKER_MAX_COUNT", 3);
	
	GASSER_MAX_COUNT = Lua_GetVariable("GASSER_MAX_COUNT", 3);
	
	OBSTACLE_MAX_COUNT = Lua_GetVariable("OBSTACLE_MAX_COUNT", 3);
	
	BOX_MAX_COUNT = Lua_GetVariable("OBSTACLE_MAX_COUNT", 2);
	
	SPIKEBALL_MAX_COUNT = Lua_GetVariable("SPIKEBALL_MAX_COUNT", 4);
	
	MAX_MONSTERS = Lua_GetVariable("MAX_MONSTERS", 65);
	...
	M_TANK_COST = Lua_GetVariable("M_TANK_COST", 38);
	...
	M_DEFAULT_COST = Lua_GetVariable("M_DEFAULT_COST", 45);
	M_FLYER_CONTROL_COST = Lua_GetVariable("M_FLYER_CONTROL_COST", 12);
	M_INSANE_CONTROL_COST = Lua_GetVariable("M_INSANE_CONTROL_COST", 12);
	M_SOLDIERLT_CONTROL_COST = Lua_GetVariable("M_SOLDIERLT_CONTROL_COST", 12);
	M_SOLDIER_CONTROL_COST = Lua_GetVariable("M_SOLDIER_CONTROL_COST", 12);
	M_GUNNER_CONTROL_COST = Lua_GetVariable("M_GUNNER_CONTROL_COST", 12);
	M_CHICK_CONTROL_COST = Lua_GetVariable("M_CHICK_CONTROL_COST", 12);
	M_PARASITE_CONTROL_COST = Lua_GetVariable("M_PARASITE_CONTROL_COST", 12);
	M_MEDIC_CONTROL_COST = Lua_GetVariable("M_MEDIC_CONTROL_COST", 12);
	M_TANK_CONTROL_COST = Lua_GetVariable("M_TANK_CONTROL_COST", 22);
	M_BRAIN_CONTROL_COST = Lua_GetVariable("M_BRAIN_CONTROL_COST", 12);
	M_HOVER_CONTROL_COST = Lua_GetVariable("M_HOVER_CONTROL_COST", 12);
	M_SUPERTANK_CONTROL_COST = Lua_GetVariable("M_SUPERTANK_CONTROL_COST", 33);
	M_COMMANDER_CONTROL_COST = Lua_GetVariable("M_COMMANDER_CONTROL_COST", 33);
	M_MUTANT_CONTROL_COST = Lua_GetVariable("M_MUTANT_CONTROL_COST", 12);
	M_GLADIATOR_CONTROL_COST = Lua_GetVariable("M_GLADIATOR_CONTROL_COST", 12);
	M_DEFAULT_CONTROL_COST = Lua_GetVariable("M_DEFAULT_CONTROL_COST", 12);
	...
	DELAY_BOMB = Lua_GetVariable("DELAY_BOMB", 2);
	...
	VITALITY_MULT = Lua_GetVariable("VITALITY_MULT", 0.21);
	...
	EXPLODING_ARMOR_DMG_BASE = Lua_GetVariable("EXPLODING_ARMOR_DMG_BASE", 125);
	...
	EXPLODING_ARMOR_DELAY = Lua_GetVariable("EXPLODING_ARMOR_DELAY", 0.3);
	...
	SPIKER_INITIAL_HEALTH = Lua_GetVariable("SPIKER_INITIAL_HEALTH", 295);
	SPIKER_ADDON_HEALTH = Lua_GetVariable("SPIKER_ADDON_HEALTH", 85);
	SPIKER_INITIAL_DAMAGE = Lua_GetVariable("SPIKER_INITIAL_DAMAGE", 45);
	SPIKER_ADDON_DAMAGE = Lua_GetVariable("SPIKER_ADDON_DAMAGE", 25);
	SPIKER_INITIAL_SPEED = Lua_GetVariable("SPIKER_INITIAL_SPEED", 2400);
	SPIKER_ADDON_SPEED = Lua_GetVariable("SPIKER_ADDON_SPEED", 0);
	SPIKER_COST = Lua_GetVariable("SPIKER_COST", 35);
	SPIKER_DELAY = Lua_GetVariable("SPIKER_DELAY", 0.15);
	SPIKER_REFIRE_DELAY = Lua_GetVariable("SPIKER_REFIRE_DELAY", 0.7);
	...
	MIND_ABSORB_RADIUS_BONUS = Lua_GetVariable("MIND_ABSORB_RADIUS_BONUS", 2);
	MIND_ABSORB_AMOUNT_BASE = Lua_GetVariable("MIND_ABSORB_AMOUNT_BASE", 2);
	...
	AMP_DAMAGE_DURATION_BASE = Lua_GetVariable("AMP_DAMAGE_DURATION_BASE", 1);
	...
	AMP_DAMAGE_MULT_BONUS = Lua_GetVariable("AMP_DAMAGE_MULT_BONUS", 0.2);
	...
	LIFE_DRAIN_DURATION_BASE = Lua_GetVariable("LIFE_DRAIN_DURATION_BASE", 2);
	...
	CARPETBOMB_INITIAL_DAMAGE = Lua_GetVariable("CARPETBOMB_INITIAL_DAMAGE", 75);
	CARPETBOMB_ADDON_DAMAGE = Lua_GetVariable("CARPETBOMB_ADDON_DAMAGE", 35);
	...
	BOMBAREA_STARTUP_DELAY = Lua_GetVariable("BOMBAREA_STARTUP_DELAY", 4);
	...
	// BOSS MAKRON
	MAKRON_MAXVELOCITY = Lua_GetVariable("MAKRON_MAXVELOCITY", 600);
	MAKRON_INITIAL_HEALTH = Lua_GetVariable("MAKRON_INITIAL_HEALTH", 2000);
	...
	SKULL_INITIAL_HEALTH = Lua_GetVariable("SKULL_INITIAL_HEALTH", 320);
	SKULL_ADDON_HEALTH = Lua_GetVariable("SKULL_ADDON_HEALTH", 50);
	SKULL_INITIAL_DAMAGE = Lua_GetVariable("SKULL_INITIAL_DAMAGE", 2);
	...
	SKULL_ATTACK_RANGE = Lua_GetVariable("SKULL_ATTACK_RANGE", 150);
	SKULL_COST = Lua_GetVariable("SKULL_COST", 50);
	...
	M_SOLDIER_INITIAL_HEALTH = Lua_GetVariable("M_SOLDIER_INITIAL_HEALTH", 150);
	M_SOLDIER_ADDON_HEALTH = Lua_GetVariable("M_SOLDIER_ADDON_HEALTH", 115);
	M_SOLDIER_INITIAL_ARMOR = Lua_GetVariable("M_SOLDIER_INITIAL_ARMOR", 55);
	M_SOLDIER_ADDON_ARMOR = Lua_GetVariable("M_SOLDIER_ADDON_ARMOR", 35);
	...
	BRAIN_ADDON_KNOCKBACK = Lua_GetVariable("BRAIN_ADDON_KNOCKBACK", -5);
	...
	SPIKEBALL_INITIAL_HEALTH = Lua_GetVariable("SPIKEBALL_INITIAL_HEALTH", 250);
	
	SPIKEBALL_ADDON_HEALTH = Lua_GetVariable("SPIKEBALL_ADDON_HEALTH", 25);
	...
	SPIKEBALL_COST = Lua_GetVariable("SPIKEBALL_COST", 15);
	SPIKEBALL_DELAY = Lua_GetVariable("SPIKEBALL_DELAY", 1.0);


	// DRONE HEALTH N SHIELD CONFIGURATION
	 
	 DRONE_MUTANT_INITIAL_LIFE  = Lua_GetVariable("DRONE_MUTANT_INITIAL_LIFE", 950);
	 DRONE_MUTANT_INITIAL_SHIELD = Lua_GetVariable("DRONE_MUTANT_INITIAL_SHIELD", 300);

	 DRONE_MEDIC_INITIAL_LIFE = Lua_GetVariable("DRONE_MEDIC_INITIAL_LIFE", 380);
	 DRONE_MEDIC_INITIAL_SHIELD = Lua_GetVariable("DRONE_MEDIC_INITIAL_SHIELD", 420);

	 DRONE_TANK_INITIAL_LIFE = Lua_GetVariable("DRONE_TANK_INITIAL_LIFE", 580);
	 DRONE_TANK_INITIAL_SHIELD = Lua_GetVariable("DRONE_TANK_INITIAL_SHIELD", 750);

	 DRONE_GLADIATOR_INITIAL_LIFE = Lua_GetVariable("DRONE_GUNNER_INITIAL_LIFE", 380);
	 DRONE_GLADIATOR_INITIAL_SHIELD = Lua_GetVariable("DRONE_GUNNER_INITIAL_SHIELD", 350);
	
	 DRONE_BRAIN_INITIAL_LIFE = Lua_GetVariable("DRONE_BRAIN_INITIAL_LIFE", 380);
	 DRONE_BRAIN_INITIAL_SHIELD = Lua_GetVariable("DRONE_BRAIN_INITIAL_SHIELD", 950);

	 DRONE_GUNNER_INITIAL_LIFE = Lua_GetVariable("DRONE_GUNNER_INITIAL_LIFE", 480);
	 DRONE_GUNNER_INITIAL_SHIELD = Lua_GetVariable("DRONE_GUNNER_INITIAL_SHIELD", 400);

	 DRONE_BERSERK_INITIAL_LIFE = Lua_GetVariable("DRONE_BERSERK_INITIAL_LIFE", 550);
	 DRONE_BERSERK_INITIAL_SHIELD = Lua_GetVariable("DRONE_BERSERK_INITIAL_SHIELD", 350);

	 DRONE_PARASITE_INITIAL_LIFE = Lua_GetVariable("DRONE_PARASITE_INITIAL_LIFE", 450);
	 DRONE_PARASITE_INITIAL_SHIELD = Lua_GetVariable("DRONE_PARASITE_INITIAL_SHIELD", 150);

	 DRONE_BITCH_INITIAL_LIFE = Lua_GetVariable("DRONE_BITCH_INITIAL_LIFE", 180);
	 DRONE_BITCH_INITIAL_SHIELD = Lua_GetVariable("DRONE_BITCH_INITIAL_SHIELD", 215);


	 DRONE_SUPERTANK_INITIAL_LIFE = Lua_GetVariable("DRONE_SUPERTANK_INITIAL_LIFE", 3000);
	 DRONE_SUPERTANK_INITIAL_SHIELD = Lua_GetVariable("DRONE_SUPERTANK_INITIAL_SHIELD", 5000);

	 DRONE_COMMANDER_INITIAL_LIFE = Lua_GetVariable("DRONE_COMMANDER_INITIAL_LIFE", 900);
	 DRONE_COMMANDER_INITIAL_SHIELD = Lua_GetVariable("DRONE_COMMANDER_INITIAL_SHIELD", 1800);

	 DRONE_MAKRON_INITIAL_LIFE = Lua_GetVariable("DRONE_MAKRON_INITIAL_LIFE", 2500);
	 DRONE_MAKRON_INITIAL_SHIELD = Lua_GetVariable("DRONE_MAKRON_INITIAL_SHIELD", 3500);

	 DRONE_JORG_INITIAL_LIFE = Lua_GetVariable("DRONE_JORG_INITIAL_LIFE", 4500);
	 DRONE_JORG_INITIAL_SHIELD = Lua_GetVariable("DRONE_JORG_INITIAL_SHIELD", 3500);

	 DRONE_INFANTRY_INITIAL_LIFE = Lua_GetVariable("DRONE_INFANTRY_INITIAL_LIFE", 350);
	 DRONE_INFANTRY_INITIAL_SHIELD = Lua_GetVariable("DRONE_INFANTRY_INITIAL_SHIELD", 450);



	 DRONE_LESSER_LIFE_FACTOR = Lua_GetVariable("DRONE_LESSER_LIFE_FACTOR", 22);
	 DRONE_LESSER_SHIELD_FACTOR = Lua_GetVariable("DRONE_LESSER_SHIELD_FACTOR", 32);

	 DRONE_MEDIUM_LIFE_FACTOR		= Lua_GetVariable("DRONE_MEDIUM_LIFE_FACTOR", 36);
	 DRONE_MEDIUM_SHIELD_FACTOR	= Lua_GetVariable("DRONE_MEDIUM_SHIELD_FACTOR", 56);

	 DRONE_BOSS_LIFE_FACTOR		= Lua_GetVariable("DRONE_BOSS_LIFE_FACTOR", 3);
	 DRONE_BOSS_SHIELD_FACTOR		= Lua_GetVariable("DRONE_BOSS_SHIELD_FACTOR", 3);
}