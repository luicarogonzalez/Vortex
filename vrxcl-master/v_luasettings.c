...
#pragma endregion /*Weapons Parameters*/
	...
	// DRONE HEALTH N SHIELD CONFIGURATION
	 ...
	 DRONE_COMMANDER_INITIAL_LIFE = Lua_GetVariable("DRONE_COMMANDER_INITIAL_LIFE", 3500);
	 DRONE_COMMANDER_INITIAL_SHIELD = Lua_GetVariable("DRONE_COMMANDER_INITIAL_SHIELD", 1500);
	 ...
	 DRONE_BOSS_LIFE_FACTOR		= Lua_GetVariable("DRONE_BOSS_LIFE_FACTOR", 2);
