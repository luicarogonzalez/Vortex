...
#pragma region BFG10K
	...
	BFG10K_RADIUS = Lua_GetVariable("BFG10K_RADIUS", 256);
	BFG10K_INITIAL_DURATION = Lua_GetVariable("BFG10K_INITIAL_DURATION", 0.9);
	BFG10K_ADDON_DURATION = Lua_GetVariable("BFG10K_ADDON_DURATION", 0.2);
