...
#pragma region BLASTER
	...
	BLASTER_ADDON_DAMAGE_MAX = Lua_GetVariable("BLASTER_ADDON_DAMAGE_MAX", 7);
...
#pragma region WEAPON_20MM
	WEAPON_20MM_INITIAL_DMG = Lua_GetVariable("WEAPON_20MM_INITIAL_DMG", 5);
	WEAPON_20MM_ADDON_DMG = Lua_GetVariable("WEAPON_20MM_ADDON_DMG", 2);
	WEAPON_20MM_INITIAL_RANGE = Lua_GetVariable("WEAPON_20MM_INITIAL_RANGE", 950);
	WEAPON_20MM_ADDON_RANGE = Lua_GetVariable("WEAPON_20MM_ADDON_RANGE", 45);
	WEAPON_20MM_ADDON_HEATDAMAGE = Lua_GetVariable("WEAPON_20MM_ADDON_HEATDAMAGE", 1);
#pragma endregion	
#pragma region SHOTGUN
	SHOTGUN_INITIAL_DAMAGE = Lua_GetVariable("SHOTGUN_INITIAL_DAMAGE", 4);
...
#pragma region SUPERSHOTGUN
	SUPERSHOTGUN_INITIAL_DAMAGE = Lua_GetVariable("SUPERSHOTGUN_INITIAL_DAMAGE", 5);
...
#pragma region HYPERBLASTER
	...
	HYPERBLASTER_INITIAL_SPEED = Lua_GetVariable("HYPERBLASTER_INITIAL_SPEED", 600);
	HYPERBLASTER_ADDON_SPEED = Lua_GetVariable("HYPERBLASTER_ADDON_SPEED", 18);
#pragma endregion	
#pragma region RAILGUN
	RAILGUN_INITIAL_DAMAGE = Lua_GetVariable("RAILGUN_INITIAL_DAMAGE", 100);
	RAILGUN_ADDON_DAMAGE = Lua_GetVariable("RAILGUN_ADDON_DAMAGE", 10);
	RAILGUN_ADDON_HEATDAMAGE = Lua_GetVariable("RAILGUN_ADDON_HEATDAMAGE", 1);
...
#pragma region BFG10K
	...
	BFG10K_INITIAL_DURATION = Lua_GetVariable("BFG10K_INITIAL_DURATION", 0.7);
...
#pragma endregion /*Weapons Parameters*/
	...
	SPIKER_INITIAL_HEALTH = Lua_GetVariable("SPIKER_INITIAL_HEALTH", 175);
	SPIKER_ADDON_HEALTH = Lua_GetVariable("SPIKER_ADDON_HEALTH", 75);
	SPIKER_INITIAL_DAMAGE = Lua_GetVariable("SPIKER_INITIAL_DAMAGE", 45);
	SPIKER_ADDON_DAMAGE = Lua_GetVariable("SPIKER_ADDON_DAMAGE", 15);
