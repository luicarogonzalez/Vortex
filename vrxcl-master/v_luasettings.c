...
#pragma region SABRE
	SABRE_INITIAL_DAMAGE = Lua_GetVariable("SABRE_INITIAL_DAMAGE", 80);
	SABRE_ADDON_DAMAGE = Lua_GetVariable("SABRE_ADDON_DAMAGE", 8);
...
#pragma region WEAPON_20MM
	WEAPON_20MM_INITIAL_DMG = Lua_GetVariable("WEAPON_20MM_INITIAL_DMG", 1);
	WEAPON_20MM_ADDON_DMG = Lua_GetVariable("WEAPON_20MM_ADDON_DMG", 0.5);
	...
	WEAPON_20MM_ADDON_HEATDAMAGE = Lua_GetVariable("WEAPON_20MM_ADDON_HEATDAMAGE", 5.5);
#pragma endregion	
#pragma region SHOTGUN
	SHOTGUN_INITIAL_DAMAGE = Lua_GetVariable("SHOTGUN_INITIAL_DAMAGE", 3);
	SHOTGUN_ADDON_DAMAGE = Lua_GetVariable("SHOTGUN_ADDON_DAMAGE", 1.5);
...
#pragma region GRENADES
	GRENADE_INITIAL_DAMAGE = Lua_GetVariable("GRENADE_INITIAL_DAMAGE", 100);
	GRENADE_ADDON_DAMAGE = Lua_GetVariable("GRENADE_ADDON_DAMAGE", 20);
...
#pragma region GRENADELAUNCHER
	...
	GRENADELAUNCHER_ADDON_DAMAGE = Lua_GetVariable("GRENADELAUNCHER_ADDON_DAMAGE", 18);
...
#pragma region ROCKETLAUNCHER
	ROCKETLAUNCHER_INITIAL_DAMAGE = Lua_GetVariable("ROCKETLAUNCHER_INITIAL_DAMAGE", 60);
	ROCKETLAUNCHER_ADDON_DAMAGE = Lua_GetVariable("ROCKETLAUNCHER_ADDON_DAMAGE", 18);
...
#pragma region RAILGUN
	RAILGUN_INITIAL_DAMAGE = Lua_GetVariable("RAILGUN_INITIAL_DAMAGE", 95);
	RAILGUN_ADDON_DAMAGE = Lua_GetVariable("RAILGUN_ADDON_DAMAGE", 5);
	RAILGUN_ADDON_HEATDAMAGE = Lua_GetVariable("RAILGUN_ADDON_HEATDAMAGE", 2.5);

#pragma endregion
#pragma region BFG10K
	BFG10K_INITIAL_DAMAGE = Lua_GetVariable("BFG10K_INITIAL_DAMAGE", 40);
...
#pragma endregion /*Weapons Parameters*/
	...
	FURY_FACTOR_MAX = Lua_GetVariable("FURY_FACTOR_MAX", 3.0);
	...
	SENTRY_INITIAL_BULLETDAMAGE = Lua_GetVariable("SENTRY_INITIAL_BULLETDAMAGE", 35);
	SENTRY_ADDON_BULLETDAMAGE = Lua_GetVariable("SENTRY_ADDON_BULLETDAMAGE", 9);
	...
	// DRONE HEALTH N SHIELD CONFIGURATION
	 ...
	 DRONE_MUTANT_INITIAL_LIFE  = Lua_GetVariable("DRONE_MUTANT_INITIAL_LIFE", 550);
	 DRONE_MUTANT_INITIAL_SHIELD = Lua_GetVariable("DRONE_MUTANT_INITIAL_SHIELD", 200);

	 DRONE_MEDIC_INITIAL_LIFE = Lua_GetVariable("DRONE_MEDIC_INITIAL_LIFE", 385);
	 DRONE_MEDIC_INITIAL_SHIELD = Lua_GetVariable("DRONE_MEDIC_INITIAL_SHIELD", 450);

	 DRONE_TANK_INITIAL_LIFE = Lua_GetVariable("DRONE_TANK_INITIAL_LIFE", 580);
	 DRONE_TANK_INITIAL_SHIELD = Lua_GetVariable("DRONE_TANK_INITIAL_SHIELD", 675);

	 DRONE_GLADIATOR_INITIAL_LIFE = Lua_GetVariable("DRONE_GUNNER_INITIAL_LIFE", 380);
	 DRONE_GLADIATOR_INITIAL_SHIELD = Lua_GetVariable("DRONE_GUNNER_INITIAL_SHIELD", 290);
	
	 DRONE_BRAIN_INITIAL_LIFE = Lua_GetVariable("DRONE_BRAIN_INITIAL_LIFE", 550);
	 DRONE_BRAIN_INITIAL_SHIELD = Lua_GetVariable("DRONE_BRAIN_INITIAL_SHIELD", 900);

	 DRONE_GUNNER_INITIAL_LIFE = Lua_GetVariable("DRONE_GUNNER_INITIAL_LIFE", 400);
	 DRONE_GUNNER_INITIAL_SHIELD = Lua_GetVariable("DRONE_GUNNER_INITIAL_SHIELD", 400);

	 DRONE_BERSERK_INITIAL_LIFE = Lua_GetVariable("DRONE_BERSERK_INITIAL_LIFE", 400);
	 DRONE_BERSERK_INITIAL_SHIELD = Lua_GetVariable("DRONE_BERSERK_INITIAL_SHIELD", 250);

	 DRONE_PARASITE_INITIAL_LIFE = Lua_GetVariable("DRONE_PARASITE_INITIAL_LIFE", 380);
	 DRONE_PARASITE_INITIAL_SHIELD = Lua_GetVariable("DRONE_PARASITE_INITIAL_SHIELD", 180);

	 DRONE_BITCH_INITIAL_LIFE = Lua_GetVariable("DRONE_BITCH_INITIAL_LIFE", 350);
	 DRONE_BITCH_INITIAL_SHIELD = Lua_GetVariable("DRONE_BITCH_INITIAL_SHIELD", 225);


	 DRONE_SUPERTANK_INITIAL_LIFE = Lua_GetVariable("DRONE_SUPERTANK_INITIAL_LIFE", 6000);
	 DRONE_SUPERTANK_INITIAL_SHIELD = Lua_GetVariable("DRONE_SUPERTANK_INITIAL_SHIELD", 3000);

	 DRONE_COMMANDER_INITIAL_LIFE = Lua_GetVariable("DRONE_COMMANDER_INITIAL_LIFE", 500);
	 ...
	 DRONE_LESSER_LIFE_FACTOR = Lua_GetVariable("DRONE_LESSER_LIFE_FACTOR", 3);
	 DRONE_LESSER_SHIELD_FACTOR = Lua_GetVariable("DRONE_LESSER_SHIELD_FACTOR", 4);

	 DRONE_MEDIUM_LIFE_FACTOR		= Lua_GetVariable("DRONE_MEDIUM_LIFE_FACTOR", 4.5);
	 DRONE_MEDIUM_SHIELD_FACTOR	= Lua_GetVariable("DRONE_MEDIUM_SHIELD_FACTOR", 5.5);
