...
#pragma region BFG10K
	BFG10K_INITIAL_DAMAGE = Lua_GetVariable("BFG10K_INITIAL_DAMAGE", 70);
	BFG10K_ADDON_DAMAGE = Lua_GetVariable("BFG10K_ADDON_DAMAGE", 3);
...
#pragma endregion /*Weapons Parameters*/
	...
	MIND_ABSORB_AMOUNT_BASE = Lua_GetVariable("MIND_ABSORB_AMOUNT_BASE", 1);
