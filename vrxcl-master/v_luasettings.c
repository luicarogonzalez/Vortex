...
void Lua_LoadVariables()
{
	...
	INITIAL_HEALTH_VAMPIRE = Lua_GetVariable("INITIAL_HEALTH_VAMPIRE", 108);
	LEVELUP_HEALTH_VAMPIRE = Lua_GetVariable("LEVELUP_HEALTH_VAMPIRE", 7);
...
#pragma region WEAPON_20MM
	...
	WEAPON_20MM_INITIAL_RANGE = Lua_GetVariable("WEAPON_20MM_INITIAL_RANGE", 1150);
	WEAPON_20MM_ADDON_RANGE = Lua_GetVariable("WEAPON_20MM_ADDON_RANGE", 45);
	WEAPON_20MM_ADDON_HEATDAMAGE = Lua_GetVariable("WEAPON_20MM_ADDON_HEATDAMAGE", 4);
#pragma endregion	
...
#pragma region BFG10K
	BFG10K_INITIAL_DAMAGE = Lua_GetVariable("BFG10K_INITIAL_DAMAGE", 35);
	...
	BFG10K_RADIUS = Lua_GetVariable("BFG10K_RADIUS", 350);
...
#pragma endregion /*Weapons Parameters*/
	...
	PRECISION_TUNING_DELAY_FACTOR = Lua_GetVariable("PRECISION_TUNING_DELAY_FACTOR", 0.2);
	...
	MINISENTRY_INITIAL_HEALTH = Lua_GetVariable("MINISENTRY_INITIAL_HEALTH", 100);
	MINISENTRY_ADDON_HEALTH = Lua_GetVariable("MINISENTRY_ADDON_HEALTH", 55);
	MINISENTRY_INITIAL_ARMOR = Lua_GetVariable("MINISENTRY_INITIAL_ARMOR", 190);
	...
	SENTRY_INITIAL_BULLETDAMAGE = Lua_GetVariable("SENTRY_INITIAL_BULLETDAMAGE", 25);
	SENTRY_ADDON_BULLETDAMAGE = Lua_GetVariable("SENTRY_ADDON_BULLETDAMAGE", 10);
	...
	SENTRY_UPGRADE = Lua_GetVariable("SENTRY_UPGRADE", 75);
	...
	// DRONE HEALTH N SHIELD CONFIGURATION
	 ...
	 DRONE_LESSER_LIFE_FACTOR = Lua_GetVariable("DRONE_LESSER_LIFE_FACTOR", 2);
	 DRONE_LESSER_SHIELD_FACTOR = Lua_GetVariable("DRONE_LESSER_SHIELD_FACTOR", 3);

	 DRONE_MEDIUM_LIFE_FACTOR		= Lua_GetVariable("DRONE_MEDIUM_LIFE_FACTOR", 3);
	 DRONE_MEDIUM_SHIELD_FACTOR	= Lua_GetVariable("DRONE_MEDIUM_SHIELD_FACTOR", 4);
