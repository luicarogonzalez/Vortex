...
void Lua_LoadVariables()
{
	...
	INITIAL_HEALTH_ENGINEER = Lua_GetVariable("INITIAL_HEALTH_ENGINEER", 70);
	...
	INITIAL_HEALTH_VAMPIRE = Lua_GetVariable("INITIAL_HEALTH_VAMPIRE", 110);
	...
	INITIAL_HEALTH_POLTERGEIST = Lua_GetVariable("INITIAL_HEALTH_POLTERGEIST", 115); //ALIEN
